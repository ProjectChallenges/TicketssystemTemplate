...
public class TicketSystem_FK_Main {

    public static void main(String[] args) {
        // Erstellen von Benutzern
        User user1 = new User(1, "user1", "department1");
        User user2 = new User(2, "user2", "department2");
        ...
        TicketAssignment assignment1 = new TicketAssignment(1, ticket1.getTicketId(), user1.getUserId());
        TicketAssignment assignment2 = new TicketAssignment(2, ticket2.getTicketId(), user2.getUserId());
        ...
        System.out.println("Ticket 1 zugewiesen an: User ID " + assignment1.getUserId());
        System.out.println("Ticket 2 zugewiesen an: User ID " + assignment2.getUserId());
    }
}
